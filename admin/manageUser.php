...
<?php include 'layouts/sidebar.php' ?>
			...
			<div class="content-wrapper">
				...
				<tbody>
				<?php $adminUsers=selectUserDatabase($conn);
				$sn=0;
								// dump($adminUsers);
								foreach ($adminUsers as $key => $adminUser):
									# code...
																?>
								<tr>
									<td><center><?php echo ++$sn; ?></td>
									<td><center><?php echo $adminUser['fname']; ?></center></td>
									<td><center><?php echo $adminUser['lname']; ?></center></td>
									<td><center><?php echo $adminUser['email']; ?></center></td>
									<td><center><?php echo $adminUser['password']; ?></center></td>
									<td><center><?php echo $adminUser['phoneno']; ?></center></td>
									<td><center><?php echo $adminUser['status']; ?></center></td>
